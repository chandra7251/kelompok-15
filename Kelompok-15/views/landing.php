            ...
            <div class="grid lg:grid-cols-2 gap-16 w-full items-center">
                ...
                <div class="z-10 max-w-xl">
                    <h1 class="text-4xl lg:text-5xl font-bold leading-tight mb-6">
                        FINANCE WITH<br>
                        SMART HABBIT AND<br>
                        <span class="bg-gradient-to-r from-[#00C6FB] to-[#00F29C] bg-clip-text text-transparent">FINANCIAL AWARENESS</span>
                    </h1>
                    <p class="text-white/70 text-base leading-relaxed">
                        Kelola uang dengan lebih sadar, pantau pemasukan dan pengeluaran, serta jaga kesehatan finansial agar keuangan tetap stabil dan terkontrol.
                    </p>
                </div>
        ...
        <div class="container mx-auto px-8 lg:px-20 relative z-10 pb-16">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="space-y-6 relative">
                    ...
                    <h3 class="text-2xl lg:text-3xl font-bold bg-gradient-to-r from-[#00C6FB] to-[#00F29C] bg-clip-text text-transparent pb-2">
                        SAFE AND RELIABLE MONITORING
                    </h3>
                    
                    <p class="text-white/70 text-base leading-relaxed max-w-xl">
                        Awasi aktivitas keuangan anak secara real-time, lakukan transfer dengan aman, dan pastikan penggunaan dana tetap terkendali dan bertanggung jawab.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-36 bg-[#0B1C2E]">
        <div class="container mx-auto px-8 lg:px-16">
            <div class="flex flex-col items-center text-center space-y-8">
                <h2 class="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-[#00C6FB] to-[#00F29C] bg-clip-text text-transparent">
                    TUNGGU APALAGI?
                </h2>
                ...
                <a href="index.php?page=register" class="group inline-flex items-center gap-4 pl-6 pr-2 py-2 bg-gradient-to-r from-[#00C6FB] to-[#00F29C] rounded-full hover:shadow-lg hover:shadow-[#00C6FB]/40 transition-all">
                    ...
                    <div class="w-8 h-8 bg-[#0B1C2E] rounded-full flex items-center justify-center group-hover:bg-[#0E2A3F] transition-colors">
                        <svg class="w-4 h-4 text-[#00F29C]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14m-7-7l7 7-7 7"/></svg>
                    </div>
                </a>
            </div>
        </div>
