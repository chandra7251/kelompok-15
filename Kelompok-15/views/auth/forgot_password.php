...
<div class="w-full max-w-[1750px] mx-auto px-8 lg:px-24 min-h-screen flex items-stretch relative z-10">
    <div class="absolute top-12 left-8 lg:left-24 flex items-center gap-3">
        ...
        <span
            class="text-xl font-bold bg-gradient-to-r from-[#fb7185] to-[#ec4899] bg-clip-text text-transparent">KeuanganKu</span>
    </div>
            ...
            <div class="pt-10 space-y-12">
                ...
                <div class="space-y-6">
                    <div class="flex items-start gap-5 group">
                        <div
                            class="w-12 h-12 rounded-xl border border-rose-500/20 flex items-center justify-center shrink-0 bg-[#0b1324]/80 group-hover:bg-rose-900/30 transition shadow-lg">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-xs mt-1 leading-snug">Proses reset password terenkripsi
                                end-to-end.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="group">
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-6 flex items-center pointer-events-none">
                                    <svg class="w-7 h-7 text-gray-500/60 stroke-current group-focus-within:text-rose-400 transition"
