...
<div
    class="min-h-screen w-full bg-gradient-to-b from-[#051933] to-[#0A2547] flex relative overflow-hidden font-sans text-[#EAF6FF]">

    <div class="absolute bottom-0 right-0 w-full lg:w-[50%] z-0 pointer-events-none">
        <svg class="w-full h-auto max-h-[180px] lg:max-h-[300px]" viewBox="0 0 1440 320" fill="none"
            ...
            <path fill="#2FAE9A" fill-opacity="1"
                d="M0,320 C100,280 250,120 450,150 C650,180 750,260 950,210 C1150,160 1250,20 1440,70 V320 H0 Z"></path>
        </svg>
    </div>
    ...
    <div
        ...
        <div class="w-full max-w-md mx-auto mt-10 lg:mt-0">
            ...
            <form action="index.php?page=register&action=submit" method="POST" class="space-y-5">
                ...
                <div class="space-y-1 h-[76px]">
                    <label id="label-dynamic-1" class="text-sm font-medium text-[#EAF6FF]/80 ml-1">NIM (Nomor Induk
                        Mahasiswa)</label>
            ...
            <div class="inline-block text-left">
                <div class="flex items-start gap-4 ">
                    ...
                    <p class="text-white text-[19px] font-normal leading-relaxed tracking-wide max-w-2xl">
                        DISINI BAKAL ADA <span
                            class="bg-gradient-to-r from-[#00C6FB] to-[#00F29C] text-[#0B2A4A] font-extrabold px-2 py-0.5 rounded-md mx-1">DEKSRIPSI</span>
                        SINGKAT<br>
