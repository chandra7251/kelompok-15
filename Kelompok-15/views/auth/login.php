                        ...
                        <div class="group">
                            <div class="relative">
                                ...
                                <button type="button" id="togglePassword"
                                    class="absolute inset-y-0 right-0 pr-6 flex items-center text-gray-400 hover:text-cyan-400 transition"
                                    onclick="togglePasswordVisibility()">
                                    <svg id="eyeIcon" class="w-6 h-6" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
