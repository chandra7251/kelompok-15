            ...
            <div class="pt-10 space-y-12">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-start gap-5 group">
                        <!-- Icon Box -->
                        <div class="w-12 h-12 rounded-xl border border-cyan-500/20 flex items-center justify-center shrink-0 bg-[#0b1324]/80 group-hover:bg-cyan-900/30 transition shadow-lg">
                        ...
                        <!-- Text -->
                        <div>
                            <p class="text-white font-bold text-sm leading-snug">Mahasiswa Bisa Bayar UKT Kata Kata Lorem ipsum (Bahasa Inggris baris 1)</p>
                            <p class="text-gray-500 text-xs mt-1 leading-snug">Mahasiswa Kata Kata Lorem ipsum (Bahasa Inggris baris 2)</p>
                        </div>
                    </div>
                    <?php endforeach; ?>
                </div>
                    ...
                    <form action="index.php?page=login&action=submit" method="POST" class="space-y-8">
                        ...
                        <div class="group">
                             <div class="relative">
                                ...
                                <div class="absolute inset-y-0 left-0 pl-6 flex items-center pointer-events-none">
                                    <svg class="w-7 h-7 text-gray-500/60 stroke-current group-focus-within:text-cyan-400 transition" fill="none" viewBox="0 0 24 24">
                        ...
                        <div class="group">
                            <div class="relative">
                                ...
                                <!-- Toggle Eye -->
                                <button type="button" class="absolute inset-y-0 right-0 pr-6 flex items-center text-[#6e4635] hover:text-cyan-400 transition opacity-60 hover:opacity-100">
