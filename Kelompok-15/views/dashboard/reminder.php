    ...
    <div class="lg:col-span-1">
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <form action="index.php?page=reminder&action=store" method="POST" class="space-y-4">
                ...
                <button type="submit"
                    class="w-full bg-indigo-600 text-white py-2 rounded-lg font-medium hover:bg-indigo-700">Tambah
                    Reminder</button>
            </form>
        </div>
    </div>
                        ...
                        <div class="flex items-center justify-between p-4 <?= $bgClass ?> border rounded-lg">
                            ...
                            <div class="flex items-center space-x-2">
                                <a href="index.php?page=reminder&action=send&id=<?= $r['id'] ?>"
                                    class="px-3 py-1 bg-blue-100 text-blue-700 rounded-lg text-sm hover:bg-blue-200">Kirim
                                    Email</a>
                                <form action="index.php?page=reminder&action=delete" method="POST"
                                    ...
                                    <button type="submit"
                                        class="px-3 py-1 bg-red-100 text-red-700 rounded-lg text-sm hover:bg-red-200">Hapus</button>
                                </form>
                            </div>
                        </div>
                    <?php endforeach; ?>
