...
<div class="py-8 px-6">
    ...
    <div class="flex items-center justify-center relative">
        ...
        <a href="index.php?page=dashboard" class="absolute right-0 text-[#00C6FB] hover:text-[#00F29C] text-sm font-medium transition-colors">← Kembali
            ke Dashboard</a>
    </div>
</div>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex-1 h-3 bg-white/5 rounded-full overflow-hidden">
                            <div class="h-full bg-emerald-500" style="width: <?= $settings['threshold_hemat'] ?>%"></div>
                        </div>
                    </div>
                </div>
