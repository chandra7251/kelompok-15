...
<div class="w-full mx-auto px-3 md:px-6 py-4 pb-20 space-y-6 animate-[fadeIn_0.5s_ease-out]">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-[#00C6FB]">Kategori</h1>
            <p class="text-gray-400 mt-1">Kelola Kategori Pemasukan dan Pengeluaran</p>
        </div>
    ...
    <div class="grid md:grid-cols-2 gap-8">
        ...
        <div class="bg-[#0F2942] rounded-2xl p-6 shadow-xl border border-white/5">
            <h3 class="font-bold text-[#00F29C] mb-6 flex items-center text-lg">
                <span class="w-8 h-8 rounded-full border border-[#00F29C] flex items-center justify-center mr-3 bg-[#00F29C]/10">
            ...
            <div class="space-y-4">
                ...
                foreach ($kategoris as $kat):
                    if ($kat['tipe'] === 'pemasukan'):
                        $pemasukanCount++;
                        ?>
                        <div class="flex items-center justify-between p-4 bg-[#0A2238] rounded-xl border border-[#00F29C]/30 hover:border-[#00F29C] transition group">
                            <div>
        ...
        <div class="bg-[#0F2942] rounded-2xl p-6 shadow-xl border border-white/5">
            <h3 class="font-bold text-[#FF6B6B] mb-6 flex items-center text-lg">
                <span class="w-8 h-8 rounded-full border border-[#FF6B6B] flex items-center justify-center mr-3 bg-[#FF6B6B]/10">
            ...
            <div class="space-y-4">
                ...
                foreach ($kategoris as $kat):
                    if ($kat['tipe'] === 'pengeluaran'):
                        $pengeluaranCount++;
                        ?>
                        <div class="flex items-center justify-between p-4 bg-[#0A2238] rounded-xl border border-[#FF6B6B]/30 hover:border-[#FF6B6B] transition group">
                            <div>
                                <p class="font-bold text-white"><?= e($kat['nama']) ?></p>
                                <p class="text-xs text-gray-400 mt-1"><?= $kat['transaksi_count'] ?> Transaksi</p>
                            </div>
