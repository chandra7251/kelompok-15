...
<div class="max-w-xl mx-auto py-8">
    ...
    <div class="bg-[#0F2942] rounded-2xl p-8 shadow-xl border border-white/5 relative overflow-hidden">
        <h2 class="text-xl font-bold text-[#00F29C] text-center mb-8">Edit Kategori</h2>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <label
                        ...
                        <span class="w-8 h-8 rounded-full border border-[#00C6FB] flex items-center justify-center mr-3
                            <?= $kategori->getTipe() === 'pemasukan' ? 'bg-[#00C6FB] text-[#051933]' : 'bg-[#00C6FB]/10 text-[#00C6FB]' ?>">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18"></path></svg>
                        </span>
                        <span class="font-bold <?= $kategori->getTipe() === 'pemasukan' ? 'text-white' : 'text-gray-300' ?>">Pemasukan</span>
                    </label>
                    <label
                        ...
                        <span class="w-8 h-8 rounded-full border border-[#FF6B6B] flex items-center justify-center mr-3
                            <?= $kategori->getTipe() === 'pengeluaran' ? 'bg-[#FF6B6B] text-[#051933]' : 'bg-[#FF6B6B]/10 text-[#FF6B6B]' ?>">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"></path></svg>
                        </span>
                        <span class="font-bold <?= $kategori->getTipe() === 'pengeluaran' ? 'text-white' : 'text-gray-300' ?>">Pengeluaran</span>
                    </label>
                </div>
            </div>
