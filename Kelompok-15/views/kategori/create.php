...
<div class="max-w-xl mx-auto py-8">
    <div class="mb-8 relative">
        <a href="index.php?page=kategori" class="text-[#00C6FB] hover:text-[#00F29C] text-sm font-medium absolute -top-8 left-0 transition-colors">←
            Kembali</a>
        <h1 class="text-2xl font-bold text-[#00C6FB] mt-2 text-center">Kategori</h1>
    ...
    <div class="bg-[#0F2942] rounded-2xl p-8 shadow-xl border border-white/5 relative overflow-hidden">
        <h2 class="text-xl font-bold text-[#00F29C] text-center mb-8">Tambah Kategori</h2>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <label
                        ...
                        <span class="w-8 h-8 rounded-full border border-[#00C6FB] flex items-center justify-center mr-3 bg-[#00C6FB]/10 group-has-[:checked]:bg-[#00C6FB] group-has-[:checked]:text-[#051933] text-[#00C6FB] transition-colors">
                    ...
                    <label
                        ...
                        <span class="w-8 h-8 rounded-full border border-[#FF6B6B] flex items-center justify-center mr-3 bg-[#FF6B6B]/10 group-has-[:checked]:bg-[#FF6B6B] group-has-[:checked]:text-[#051933] text-[#FF6B6B] transition-colors">
